                ...
                <div class="row gx-0 services__active">
                    ...
                    <div class="col-xl-3">
                        <div class="services__item">
                            ...
                            <div class="services__content">
                                <div class="services__icon">
                                    <img class="light" src="{{ asset('frontendassets/img/icons/services_light_icon02.png') }}" alt="">
                                    <img class="dark" src="{{ asset('frontendassets/img/icons/services_icon02.png') }}" alt="">
                                </div>{{ asset('frontend/') }}
